...
> Note: Delta Lake 4.2 defaults to Spark 4.2, but supports Spark 4.1.0, and 4.0.1. See the [release notes for the version matrix](https://github.com/delta-io/delta/releases/tag/v4.4.0).
