      ...
      <PageLayout>
            ...
            <Grid columns={{ xs: 1, sm: 1, md: 4 }} gutter="xl">
              ...
              <ColumnWrapper style={{ gridColumn: "span 3" }}>
                ...
                <Typography variant="p">
                  ...
                  <QuoteWrapper>
                    <em>
                      &#34;Contributing to something you use on a daily basis
                      not only makes you learn the topic in depth but also
                      further drives it and thereby also your success.&#34;
                    </em>
                    <br />
                    <br />
                    Source: &nbsp;
        ...
        <Section backkground="grey" centerHeader padding="xl">
          <Typography>
            ...
            Located in Wolkersdorf, Austria, Gerhard is the key maintainer of
            the official{" "}
          ...
          <Typography>
            Gerhard possesses a strong background with the Microsoft Data
            Platform including Power BI, Azure, SQL Server and has been
            implementing traditional BI and data warehouse solutions based on
            the Microsoft Data Platform for over 15 years with a personal focus
            on analytical databases ever since. With the increased adoption of
            cloud technologies he transitioned to data engineering and building
          ...
          <Typography>
            ...
            leaders. In the Delta Lake community, Gerhard has often been seen as
            a panelist on the Delta Lake Community Office Hours and teaching
            users how to build their skills with analytical data platforms and
            big data. He also shares his knowledge as a speaker at various
            international conferences and via his blog.
          </Typography>
