---
title: Getting Started with Delta Lake - Rust
width: full
---

The following are quick start steps to work with Delta Lake using Rust.
...
5. [Click here](../getting-started) to return to the Getting Started.
