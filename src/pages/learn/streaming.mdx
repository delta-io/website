...
Learn how to use Delta tables as streaming sources and sinks.
...
or the `toTable` method in Spark 3.1 and higher, as follows. (In Spark versions before 3.1, use the `table` method instead.)
