---
title: Bringing MERGE, DELETE AND UPDATE to deltalake Python in the 0.12.0 release
...
Also credits to the amazing [contributors](https://github.com/delta-io/delta-rs/graphs/contributors) of Delta-RS, a lot of effort has gone into building the Rust API!
...
- Adding VACUUM to transaction log
