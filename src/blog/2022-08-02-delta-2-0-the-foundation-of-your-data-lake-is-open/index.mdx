...
### Schema Operations: Dynamic Partition Overwrite and Drop Columns

When it comes to schema operations, the following new features help with data write performance.
