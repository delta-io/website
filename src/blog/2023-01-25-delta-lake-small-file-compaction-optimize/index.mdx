...
## Delta Lake small file compaction pre-Delta 2.0

`OPTIMIZE` was added to Delta Lake as of version 2.0. Here’s how you can manually compact small files in Delta Lake versions prior to version 2.0. Let’s create some files to demonstrate with an example.
