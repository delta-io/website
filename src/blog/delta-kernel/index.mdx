...
author: Nick Lanham, Tathagata “TD” Das, Venki Korukanti, Scott Sandre, Allison Portis, Ryan Johnson, Rahul Potharaju
date: 2024-06-06
---
...
- **[Apache Druid](https://druid.apache.org/docs/latest/development/extensions-contrib/delta-lake)** - Druid has already added its first Delta support using
- **[Apache Flink](https://github.com/delta-io/delta/tree/master/connectors/flink)** - Even a partial migration to Delta Kernel gave 3x startup time performance improvements to the Delta Flink connector
...
- **[Delta-rs](https://github.com/delta-io/delta-rs/)** - We have worked closely with the Delta-rs community to begin [migrating](https://github.com/delta-io/delta-rs/pull/2495) to Delta Kernel.
