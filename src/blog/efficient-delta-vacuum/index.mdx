...
Using [Delta 3.1](https://delta.io/blog/delta-lake-3-1/), Optimized Writer and Auto Optimize feature, along with inventory based delta vacuum (to be released in Delta 3.2) helped us reduce the cost of maintaining large delta tables pipeline significantly.
