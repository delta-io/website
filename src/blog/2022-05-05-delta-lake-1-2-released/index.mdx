...
<b>Fig.Better automatic data compaction for faster query performance.</b>
...
**_If you have a large amount of data and only want to optimize a subset of it, you can specify an optional partition predicate using `WHERE`:_**
...
> Visit [Delta Lake](https://github.com/delta-io/delta) to learn more, you can join the Delta Lake community via [Slack](http://dbricks.co/delta-users-slack) and [Google Group](https://groups.google.com/forum/#!forum/delta-users).
