...
The [Flink/Delta Lake Connector](https://github.com/delta-io/connectors/tree/master/flink-connector/) is a JVM library to read and write data from Apache Flink applications to Delta Lake tables utilizing the [Delta Standalone JVM library](https://github.com/delta-io/connectors#delta-standalone). It includes:
